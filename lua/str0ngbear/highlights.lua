...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@number"] = colors.gold,
        ["@operator"] = colors.Fg,
        ["@parameter"] = colors.cerise,
        ["@parameter.reference"] = colors.Fg,
        ["@property"] = colors.lime,
        ...
        ["@text.literal"] = colors.lime,
        ["@text.uri"] = {fg = c.lime, fmt = 'underline'},
    ...
    hl.treesitter = {
        ...
        TSParameter = colors.cerise,
        TSParameterReference = colors.Fg,
        TSProperty = colors.lime,
...
hl.plugins.indent_blankline = {
    ...
    IndentBlanklineIndent3 = colors.lime,
...
hl.langs.tex = {
    ...
    latexTSEnvironment = { fg = c.lime, fmt = "bold" },
