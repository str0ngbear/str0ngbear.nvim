...
hl.syntax = {
    String = {fg = c.dark_sunny, fmt = cfg.code_style.strings},
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@repeat"] = {fg = c.cerise, fmt = cfg.code_style.keywords},
        ["@string"] = {fg = c.dark_sunny, fmt = cfg.code_style.strings},
        ["@string.regex"] = {fg = c.dark_sunny, fmt = cfg.code_style.strings},
    ...
    hl.treesitter = {
        ...
        TSString = {fg = c.dark_sunny, fmt = cfg.code_style.strings},
        TSStringRegex = {fg = c.dark_sunny, fmt = cfg.code_style.strings},
